...
- **Key fields**: `loan_id`, `vintage_date`, `seasoning_month`, `charge_off_flag`, `charge_off_amount`, `outstanding_balance`, `term`, `fico_band`.
...
To increase trust and transparency, the system fits and compares several models to the cumulative charge-off data for each (vintage, FICO band) segment:
